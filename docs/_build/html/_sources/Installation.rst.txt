...
`RStudio <https://rstudio.com/products/rstudio/download/#download>`__ is
recommended. For windows users, if an earlier version of R (< 4.0) is
present in the system, please uninstall it firstly and make sure only R
>=4.0 is available.
...
We recommend user’s laptop or PC has >= 2 cores and >= 4GB memory for
running FuSViz locally.
